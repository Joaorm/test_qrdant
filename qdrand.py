...
QDRANDT_DIR = _base_dir / "data" / "qdrandt"
...
qdrant.recreate_collection(collection_name="my_books", vectors_config=vector_config)
...
records = [models.Record(id=idx, vector=encoder.encode(doc["description"]).tolist(), payload=doc )
